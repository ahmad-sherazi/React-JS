...
function First({name,price}) {
  return (
    
<div class="flex font-sans">
  <div class="flex-none w-56 relative">
    <img src="https://images.pexels.com/photos/32481915/pexels-photo-32481915/free-photo-of-charming-cottage-surrounded-by-daisy-field.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
  <form class="flex-auto p-6">
    <div class="flex flex-wrap">
      <h1 class="flex-auto font-medium text-white">
        {name}
      </h1>
