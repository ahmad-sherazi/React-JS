...
const FilterSection = ({search, setSearch, brand, setBrand, priceRange, setPriceRange, category, setCategory, 
    ...
    return (
        <div className='bg-gray-200 mt-10 p-4 py-20 rounded-md h-max '>
            <input type="text" 
               placeholder='Search..' 
               value={search}
            ...
            <h1 className='mt-5 font-semibold text-xl mb-3'>Brand</h1>
             { <select name="" id="" 
             className='bg-white w-full p-2 border-gray-200 border-2 rounded-md text-center
              ' 
                value={brand}
             ...
             <button className='bg-gradient-to-r from-gray-900 to-blue-300 text-lg font-bold text-white rounded-md px-3 py-2 mt-5 cursor-pointer'
